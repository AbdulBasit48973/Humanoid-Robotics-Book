...
const ChatbotWidget = () => {
  ...
  const sendMessage = async () => {
    ...
    try {
      ...
      if (selectedText) {
        res = await axios.post("https://abdulbasit48-humanoid-robotics.hf.space/ask/selection", {
          question: "Explain the selected text in simple terms.",
          selected_text: selectedText,
        });
      } else {
        res = await axios.post("https://abdulbasit48-humanoid-robotics.hf.space/ask", {
          question: userText,
        });
      }
